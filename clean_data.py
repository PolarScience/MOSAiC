...
cpcraw= cpcraw.loc[datastart:dataend] #This is the raw CPC data with which we work
cpcraw=cpcraw.resample('10s').mean() #resample all CPC values to same time delta (there is some 1s measurements in between)
# cpcraw['calibration mask']=
